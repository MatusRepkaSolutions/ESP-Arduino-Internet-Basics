...
$sql = "SELECT * FROM ESP_LED WHERE MAC='$macAddress'";
$result = $db->query($sql);

if ($result->num_rows > 0) {
    //If it found this MAC adress in the database > just update the IP address to the current one
    $sql = "UPDATE ESP_LED SET IP='$ipAddress' WHERE MAC='$macAddress'";
    ...
    $sql = "INSERT INTO ESP_LED (IP, MAC) VALUES ('$ipAddress', '$macAddress')";
